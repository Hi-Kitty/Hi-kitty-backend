...
public class BoardFundraiserImagePlanResponse {
    ...
    public static BoardFundraiserImagePlanResponse from(BoardFundraiserImagePlan boardFundraiserImagePlan) {
        return BoardFundraiserImagePlanResponse.builder()
                ...
                .fundraiserId(boardFundraiserImagePlan.getFundraiser().getFundraiserId())
                .name(boardFundraiserImagePlan.getFundraiser().getName())
                .profileName(boardFundraiserImagePlan.getFundraiser().getProfileName())
                .profileUrl(boardFundraiserImagePlan.getFundraiser().getProfileUrl())
